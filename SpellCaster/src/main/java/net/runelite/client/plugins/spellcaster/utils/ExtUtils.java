...
public class ExtUtils
{
	...
	public static void handleItems(List<WidgetItem> list, ActionType actionType, Flexo flexo, Client client, double scalingfactor, int delay)
	{
		if (list.isEmpty())
		{
			return;
		...
		for (WidgetItem items : list)
		{
			...
			handleSwitch(items.getCanvasBounds(), actionType, flexo, client, scalingfactor, delay);
		}
	}
